...
{
    class SmallMarioSlidingRightSprite : IMario
    {
        ...
        public SmallMarioSlidingRightSprite(Texture2D texture, int rows, int columns)
        {
            Texture = texture;
            Rows = rows;
            Columns = columns;
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            Rectangle sourceRectangle = new Rectangle(width * column - 10, height * row, width, height);
