...
{
    class SmallMarioSlidingLeftSprite : IMario
    {
        ...
        public SmallMarioSlidingLeftSprite(Texture2D texture, int rows, int columns)
        {
            Texture = texture;
            Rows = rows;
            Columns = columns;
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            Rectangle sourceRectangle = new Rectangle(width * column + 13, height * row, width, height);
