...
{
    class FireMarioSlidingLeftSprite : IMario
    {
        ...
        public FireMarioSlidingLeftSprite(Texture2D texture, int rows, int columns)
        {
            Texture = texture;
            Rows = rows;
            Columns = columns;
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            Rectangle sourceRectangle = new Rectangle(335, 120, width, height + 1);
