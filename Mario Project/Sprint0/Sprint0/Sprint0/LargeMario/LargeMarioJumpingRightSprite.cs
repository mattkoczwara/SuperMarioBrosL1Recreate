...
{
    class LargeMarioJumpingRightSprite : IMario
    {
        ...
        public LargeMarioJumpingRightSprite(Texture2D texture, int rows, int columns)
        {
            Texture = texture;
            Rows = rows;
            Columns = columns;
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            Rectangle destinationRectangle = new Rectangle((int)location.X+5, (int)location.Y-18, width, height);
            spriteBatch.Draw(Texture, destinationRectangle, sourceRectangle, this.getColor());
            destinationRectangle.X += 5;
            destinationRectangle.Width -= 5;
